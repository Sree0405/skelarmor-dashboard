...
export function GymClientsKpiRow({ clientCount, totalPaid, totalPending }: Props) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <DashboardCard
        title="Franchise clients"
      ...
      <DashboardCard title="Total pending" value={formatCurrency(totalPending)} icon={Clock} accentColor="gold" delay={0.16} />
    </div>
  );
}
