...
import { Building2, ChevronRight, Plus, RefreshCcw } from "lucide-react";
...
export function OrganizationsListPage() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeader
        title="Organizations"
        description="Create and manage tenants. Open an organization for full settings."
        action={
          <Button
            variant="outline"
            size="sm"
      ...
      <section className="space-y-3">
        <div>
          ...
          <p className="text-xs text-zinc-400">Use Manage for status, login policy, limits, and more.</p>
        </div>
                  ...
                  <tr key={org.id} className="border-t border-white/10 text-sm">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap items-center gap-2">
                        <Button size="sm" variant="outline" asChild className="border-white/15 bg-black/20 text-white/80 hover:bg-white/10">
